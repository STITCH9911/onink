...
"}")
        ...
        self.layoutWidget = QtWidgets.QWidget(parent=self.page_clientes)
        self.layoutWidget.setGeometry(QtCore.QRect(40, 20, 581, 51))
        ...
        self.bt_create_cliente = QtWidgets.QPushButton(parent=self.layoutWidget)
