...
class TiposTrabajosIndex(QWidget, Ui_tiposTrabajosIndex):
    ...
    def delete(self, obj):
        with Session() as session:
            ...
            reply = QMessageBox.question(self, "Advertencia", "Está a punto de eliminar un tipo de trabajo, si continúa no se podrá recuperar la información. ¿Desea continuar?", QMessageBox.StandardButton.Yes | QMessageBox.StandardButton.No)
    ...
    def save(self):
        ...
        with  Session() as session:
            ...
            try:
                ...
                QMessageBox.critical(self, "Error", "Ya existe este tipo de trabajo.", QMessageBox.StandardButton.Ok)
