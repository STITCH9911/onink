...
"    ")
        ...
        self.widget_menu_lateral.setGeometry(QtCore.QRect(0, 0, 171, 1346))
...
"font-size: 12pt;")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("d:\\Programacion\\Proyectos\\Python\\OnInk\\onink\\views\\images/social-network.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.bt_menu_sociales.setIcon(icon7)
...
"    }")
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap("d:\\Programacion\\Proyectos\\Python\\OnInk\\onink\\views\\images/add-client.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.bt_create_cliente.setIcon(icon16)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap("d:\\Programacion\\Proyectos\\Python\\OnInk\\onink\\views\\images/refresh.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.bt_refresh_search_clients.setIcon(icon17)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap("d:\\Programacion\\Proyectos\\Python\\OnInk\\onink\\views\\images/back-arrow.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.bt_volver_cliente_c.setIcon(icon18)
        ...
        self.bt_add_image_clients_insert.setIcon(icon19)
        ...
        self.bt_cliente_insertar_reestablecer.setIcon(icon17)
        ...
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap("d:\\Programacion\\Proyectos\\Python\\OnInk\\onink\\views\\images/save.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.bt_store_cliente.setIcon(icon20)
        ...
        self.bt_save_usernames.setIcon(icon20)
