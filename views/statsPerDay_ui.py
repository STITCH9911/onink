...
class Ui_StatsDay(object):
    def setupUi(self, StatsDay):
        ...
        self.label_7 = QtWidgets.QLabel(parent=StatsDay)
        self.label_7.setObjectName("label_7")
        self.horizontalLayout_6.addWidget(self.label_7)
        self.cb_trabajos = QtWidgets.QComboBox(parent=StatsDay)
        self.cb_trabajos.setObjectName("cb_trabajos")
        self.horizontalLayout_6.addWidget(self.cb_trabajos)
    ...
    def retranslateUi(self, StatsDay):
        ...
        self.label_7.setText(_translate("StatsDay", "Tipos de trabajos: "))
